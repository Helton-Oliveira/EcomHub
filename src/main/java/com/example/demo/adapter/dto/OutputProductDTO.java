...
public class OutputProductDTO {
    ...
    public OutputProductDTO(UUID id, String name, String description, String fileSize, String fileFormat, Integer price, Category category) {
    ...
    public OutputProductDTO(UUID id, String name, String description, Integer quantity, Integer price, Category category) {
        this.attributes.put("id", String.valueOf(id));
        this.attributes.put("name", name);
        this.attributes.put("description", description);
